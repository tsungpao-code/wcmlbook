...
class parameters():
    def __init__(self):
        ...
        self.tx_power_milli_decibel = 40        #  40 dbm
        self.tx_power = np.power(10, (self.tx_power_milli_decibel-30)/10)     # P(w)
        self.noise_density_milli_decibel = -169
        self.input_noise_power = np.power(10, ((self.noise_density_milli_decibel-30)/10)) * self.bandwidth    # P (W) * B
